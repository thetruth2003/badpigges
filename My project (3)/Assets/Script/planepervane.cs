...
public class Plane : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (isSpinning)
        {
            Pervane.transform.Rotate(Vector3.forward, spinSpeed * Time.deltaTime);  // Sadece Pervane döner
        }
        ...
        if (Input.GetKey(KeyCode.G))
        {
            if (rb != null)
            {
                ...
                Vector3 direction = Pervane.transform.forward;  // Pervanenin bakış yönü (dönme yönüne göre)
    ...
    private void OnTriggerEnter(Collider other)
    {
            ...
            other.CompareTag("AttachPointUp") || other.CompareTag("AttachPointDown"))
        {
            ...
            {
                rotationAxis = Vector3.zero; // Dönüş yapma
            }
